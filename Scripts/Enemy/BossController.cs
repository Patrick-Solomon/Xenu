...
public class BossController : MonoBehaviour
{
    ...
    private float actionCounter, shotCounter;


    public int currentHealth;
    public GameObject hitEffect, deathEffect, levelExit, bigChest;
    ...
    public void TakeDamage(int damageAmount)
    {
        ...
        if(currentHealth <= 0)
        {
            ...
            if (Vector3.Distance(PlayerController.instance.transform.position, bigChest.transform.position) < 2f)
            {
                bigChest.transform.position += new Vector3(4f, 0f, 0f);
            }
...
{
    [Header("Action")]
    public float actionLength, moveSpeed, timeBetweenShots;
    public bool shouldMove, shouldChasePlayer, moveToPoints, shouldShoot;
